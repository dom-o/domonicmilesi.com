const formulas = {
  Epley: {
    solveForMax: {
      ...
      }, str: '$$m=w\\left(1+\\frac{r}{30}\\right)$$'
    },
    solveForReps: {
      func: function(max, weight) {
        return 30 * ((max/weight) - 1)
      }, str: '$$r=30\\left(\\frac{m}{w} - 1\\right)$$'
    },
    solveForWeight: {
    ...
    solveForMax: {
      ...
      }, str: '$$m=w\\left(\\frac{36}{37-r}\\right)$$'
    },
    solveForReps: {
      func: function(max, weight) {
    ...
    solveForWeight: {
      ...
      }, str: '$$w=m\\left(\\frac{37-r}{36}\\right)$$'
    },
  }, McGlothin: {
    solveForMax: {
      func: function(reps, weight) {
    ...
    solveForWeight: {
      ...
      }, str: '$$w=m\\left(\\frac{101.3-2.67123r}{100}\\right)$$'
    },
  }, Lombardi: {
    solveForMax: {
      func: function(reps, weight) {
    ...
    solveForWeight: {
      ...
      }, str: '$$w=\\frac{m\\left(52.2+41.9e^{-0.055r}\\right)}{100}$$'
    },
  }, "O'Conner": {
    solveForMax: {
      func: function(reps, weight) {
        return weight * (1+(reps/40))
      }, str: '$$m=w\\left(1+\\frac{r}{40}\\right)$$'
    },
    solveForReps: {
      func: function(max, weight) {
        return 40 * ((max/weight) - 1)
      }, str: '$$r=40\\left(\\frac{m}{w}-1\\right)$$'
    },
    solveForWeight: {
      func: function(max, reps) {
    ...
    solveForWeight: {
      ...
      }, str: '$$w=\\frac{m\\left(48.8+53.8e^{-0.075r}\\right)}{100}$$'
    },
  }
}
